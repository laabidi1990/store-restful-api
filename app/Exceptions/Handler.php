...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $exception)
    {
        ...
        if ($exception instanceof ModelNotFoundException) {
            ...
            return $this->errorResponse("$modelName does not exist with the specified identificator", 404);
        }
        ...
        if ($exception instanceof QueryException) {
            ...
            if ($errorCode == 1451) {
                return $this->errorResponse("You cannot remove this resource permanently, it's related to other resources", 409);
            }
